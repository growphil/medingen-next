...
import { addToCart, getUser, listPrescriptions, requestProduct } from "../../api/Api"; // Adjust import based on your project structure
    ...
    <>
      ...
      <div className="select-prescription">
        ...
        <div className="text-head">
          ...
          <Link href="/capture-prescription" className="text-link">
