...
const Testimonials = ({ title = "Hear from Medingen Customers" }) => {
  const [googleRating, setGoogleRating] = useState("4.9");
  const [googleReviewCount, setGoogleReviewCount] = useState("12,482");
