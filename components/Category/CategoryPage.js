...
import { getAllCategories, getProductsByCategory, addToCart, getUser, getCartData, requestProduct, getMainCategories } from "../../api/Api";
...
export const CategoryPage = () => {
  const { navigate, params } = useLegacyRouting();
