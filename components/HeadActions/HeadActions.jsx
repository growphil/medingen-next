...
const HeadActions = ({ variant }) => {
  ...
  const { navigate, location: locationRoute } = useLegacyRouting();
  const userData = getUser(); // user data updated
    ...
    <div className={`header-actions header-search-layout ${isCheckout ? "checkout-mode" : ""}`}>
      <>
        ...
        {(isCheckout || locationRoute.pathname !== "/") && (
          <Link href="/searchbox" className={`action-icon-wrapper clickable ${!isCheckout ? "hide-on-desktop" : ""}`}>
        ...
        {/* Cart Icon */}
        <Link href="/cart" className="action-icon-wrapper clickable">
          <div className="badge">{itemCount}</div>
          <img className="action-icon" alt="Cart" src="/carticon.svg" />
        </Link>

        {/* Offers Icon */}
        <Link href="/offers" className={`action-icon-wrapper clickable ${!isCheckout ? "hide-on-desktop" : ""}`}>
          ...
          {openProfile && (
            <div className="profile-dropdown">
              <div className="profile-top">
                ...
                <Link href="/profile" className="profile-edit">
                  Edit profile
                </Link>
              </div>
