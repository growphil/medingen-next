...
export const ProfileView = () => {
  ...
  }, [loading, profile, refreshProfile, navigate]);
      ...
      didOpen: () => {
        ...
        fileInput.addEventListener("change", () => {
          ...
          if (file) {
            ...
            const filename = uploadFile(file, "profilepic");
          } else {
                ...
                <div className="user-profile-info">
                  <div className="user-avatar-wrapper">
                    <img
                      ...
                      alt={profile.name}
                      src={
                        (profile.profilePicture.startsWith("https") || profile.profilePicture.startsWith("data:image"))
                          ? profile.profilePicture
                          : `https://d1dh0rr5xj2p49.cloudfront.net/profilepic/${profile.profilePicture}`
                      }
                      onClick={handleProfilePictureChange}
                    />
